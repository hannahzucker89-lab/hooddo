    ...
    <main className="max-w-md mx-auto px-5 pb-16" dir="rtl">
      ...
      <div className="space-y-8 text-[15px] text-stone-600 leading-[1.8]">
        <div>
          ...
          <p>בקשה היא משהו שאתם צריכים — דבר קטן שקשה לעשות לבד או שנוח לקבל עזרה בו משכן קרוב.</p>
        ...
        <div className="h-px bg-stone-100" />
        <div>
          <p className="text-xl font-extrabold text-stone-900 mb-2">פרסום חדש 📝</p>
          <p>לוחצים על "פרסום חדש", בוחרים אם לפרסם בקשה או הצעה, ממלאים פרטים קצרים — וזהו. הפרסום מופיע בפיד של שכנים בסביבה.</p>
        </div>
        <div className="h-px bg-stone-100" />
        <div>
        ...
        <div>
          ...
          <p>אפשר לשתף כל פרסום עם מישהו אחר שיכול להתאים — ישירות מהכרטיסייה או מדף הפרטים.</p>
        </div>
      </div>
    </main>
  )
